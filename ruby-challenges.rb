...
#Refactor 
def word_include(array, letter)
    array.select { |value| value.include? letter.downcase}
end
p word_include(beverages_array, letter_o)
p word_include(beverages_array, letter_t)

#Original 
# def word_include(array, letter)
#     array.select do |value|
#     value.include? letter.downcase
#     end
# end
